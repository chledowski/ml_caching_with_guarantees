...
#  --experiment_base_dir="/local/data/chledows/oa" \
#  --experiment_name="leslie3d__dagger=true__fraction=100_eval_test" \
#  --cache_configs="cache_replacement/policy_learning/cache/configs/default.json" \
#  --cache_configs="cache_replacement/policy_learning/cache/configs/eviction_policy/learned.json" \
#  --memtrace_file="cache_replacement/policy_learning/cache/traces/leslie3d_valid.csv" \
#  --config_bindings="associativity=16" \
#  --config_bindings="capacity=2097152" \
#  --config_bindings="eviction_policy.scorer.checkpoint=\"/local/data/chledows/oa/leslie3d__dagger=true__fraction=100/checkpoints/20000.ckpt\"" \
#  --config_bindings="eviction_policy.scorer.config_path=\"/local/data/chledows/oa/leslie3d__dagger=true__fraction=100/model_config.json\"" \
#  --warmup_period=0